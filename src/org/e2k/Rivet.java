...
public class Rivet {
	...
	public String program_version="Rivet (Build 42) by Ian Wraith";
    ...
    public SITOR SITORHandler=new SITOR(this);
	...
	public final String MODENAMES[]={"CROWD36","XPA (10 Baud)","XPA2","XPA (20 Baud)",
			...
			"CCIR493-4","FSK200/1000","GW FSK (100 Baud)","Baudot","FSK (Raw)","SITOR-B"};
	...
	public void loadWAVfile(String fileName)	{
		...
		// SITOR-B
		else if (system==12) SITORHandler.setState(0);
	...
	private void processData ()	{		
		try	{
			...
			// SITOR-B (raw)
			else if (system==12) SITORHandler.decode(circBuffer,waveData);
		}
		catch (Exception e){
	...
	public void setSoundCardInput(boolean s) {
		...
		if (s==false)	{
			...
			// CROWD36 , XPA , XPA2 , CIS36-50 , FSK200/500 , FSK200/1000 , CCIR493-4 , GW , RTTY , SITOR
